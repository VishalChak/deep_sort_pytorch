...
def parse_args():
    ...
    parser.add_argument("--yolo_cfg", type=str, default="/media/bharatforge/Ubuntu_data/vishal/deep_sort_pytorch/YOLOv3/cfg_6/yolo.cfg")
    parser.add_argument("--yolo_weights", type=str, default="/media/bharatforge/Ubuntu_data/vishal/deep_sort_pytorch/YOLOv3/cfg_6/yolo_20000.weights")
    parser.add_argument("--yolo_names", type=str, default="/media/bharatforge/Ubuntu_data/vishal/deep_sort_pytorch/YOLOv3/cfg_6/obj.names")
